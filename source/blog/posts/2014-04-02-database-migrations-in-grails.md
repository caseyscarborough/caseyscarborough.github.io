...
<pre class="highlight"><code class="groovy">plugins {
...
<pre class="highlight"><code class="java">environments {
  development {
    dataSource {
      // Change this:
...
<pre class="highlight"><code class="groovy">class Room {
    String name
    Integer roomNumber
    String description  
...
<pre class="highlight"><code class="groovy">// Database migration for the creation of the Room class
...
<pre class="highlight"><code class="groovy">databaseChangeLog = {
